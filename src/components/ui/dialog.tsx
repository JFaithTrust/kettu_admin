...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex justify-between items-center bg-[#F6F8FA] px-4 py-[10px] sm:rounded-t-lg",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 bg-[#F6F8FA] px-4 py-[10px] sm:rounded-b-lg",
      className
    )}
    {...props}
  />
